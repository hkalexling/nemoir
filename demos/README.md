...
|---|---|---|---|---|
| [`web-interview-tutor`](web-interview-tutor/) | `web` | Browser-only capabilities (`browser.js.sandbox` with mandatory `before browser.js.sandbox(code) requires user.confirm`, `browser.js.run`, `browser.storage`), `user.elicit` Socratic loop, optional local WebLLM model, checked-in generated facades | Live: [nemoir-web-interview-tutor.pages.dev](https://nemoir-web-interview-tutor.pages.dev/) · [hkalexling.github.io/nemoir-web-interview-tutor](https://hkalexling.github.io/nemoir-web-interview-tutor/) — or `cd web-interview-tutor/app && npm ci && npm run dev` | No — open the live demo or Vite app; workflows compile to `app/src/generated/` |
...
# Web demo
nemo check demos/web-interview-tutor/workflows/interview_tutor.nemo
nemo check demos/web-interview-tutor/workflows/interview_test_runner.nemo
