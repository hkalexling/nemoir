...
export const WORKFLOW_ID = `InterviewTutor` as const;
export const ENTRY_STAGE_ID = `CaptureRequest` as const;
export const EXIT_STAGE_IDS = ["ProduceGuidance"] as const;
export const REQUIRED_CAPABILITIES = ["browser.js.run", "browser.storage.read", "user.elicit", "browser.storage.write"] as const;
export const HAS_MODEL_STAGES = true as const;
export const HAS_JS_RUN = true as const;
export const HAS_JS_SANDBOX = false as const;

export interface AgentInput {
  tutor_request: unknown;
}
